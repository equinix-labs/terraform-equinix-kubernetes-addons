...
output "daemonset_name" {
  description = "kube-vip daemonset name"
  value       = kubectl_manifest.kube_vip.name
}

output "daemonset_namespace" {
  description = "kube-vip daemonset namespace"
  value       = kubectl_manifest.kube_vip.namespace
}
